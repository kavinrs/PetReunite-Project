...
export default function Register() {
  const [form, setForm] = useState({
    username: "", email: "", password: "", full_name: "", phone_number: "", address: "", pincode: ""
  });
  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"#111", color:"white", padding:24 }}>
      <div style={{ width:520, background:"rgba(255,255,255,0.03)", padding:24, borderRadius:8 }}>
        <h2>Register</h2>
